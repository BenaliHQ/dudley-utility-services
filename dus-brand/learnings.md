...
- [2026-09-01] **Community-members sections speak TO the community, third strike — mandatory voice check.** Every sentence in a "For community members" section addresses the community member as "you" ("we make sure you understand the project"), never describes them in third person ("the people affected") and never pivots mid-section to the utility ("the reputation you've built with your community"). Audit target: the lede, the bold line, and every card. Fixed on gas, water, and fiber 9/1; transmission still carries Garrett-approved client-facing framing there — his call, don't "fix" unilaterally.

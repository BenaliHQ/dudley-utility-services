...
(function () {
  ...
  var css = [
    ...
    '.rw-q{font-size:12px;color:#5a6b74;background:#EDF6FA;padding:5px 8px;border-radius:3px;margin-bottom:7px;cursor:pointer;display:block;text-align:left;border:none;width:100%;font-family:Lato,sans-serif}',
    ...
    '.rw-ctx{font-size:12px;color:#5a6b74;background:#EDF6FA;padding:5px 8px;border-radius:3px;margin-bottom:8px;display:none}',
